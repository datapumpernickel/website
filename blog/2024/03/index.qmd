...
are not evaluated as very similar (cosine similarity of `r py$diff1`), because they are quite different, but still a lot more similar than the following comparison. 
...
yields a lower cosine similarity of `r py$diff2`, as these are semantically quite different. 
